var two_issues = [
  {
    ...
    "id": "10100",
    "self": "https://kanalyzer.atlassian.net/rest/api/2/issue/10100",
    "key": "KTD-10",
    "fields": {
      "issuetype": {
      ...
      "resolutiondate": "2015-09-11T14:08:00.000+0200",
      "workratio": -1,
      "lastViewed": "2015-09-11T14:08:00.360+0200",
      "watches": {
        "self": "https://kanalyzer.atlassian.net/rest/api/2/issue/KTD-10/watchers",
        "watchCount": 1,
        "isWatching": true
      },
      "created": "2015-09-08T10:48:40.000+0200",
      ...
      "updated": "2015-09-11T14:08:00.000+0200",
      "status": {
      ...
      "summary": "As a developer, I want to fetch and store json data globally in the application.",
      "creator": {
        "self": "https://kanalyzer.atlassian.net/rest/api/2/user?username=martin.w.greer",
        "name": "martin.w.greer",
        "key": "martin.w.greer",
      ...
      "subtasks": [
        {
          "id": "10101",
          "key": "KTD-11",
          "self": "https://kanalyzer.atlassian.net/rest/api/2/issue/10101",
          "fields": {
            "summary": "Use angular factory and services to fetch and store local json data.",
            "status": {
              "self": "https://kanalyzer.atlassian.net/rest/api/2/status/10001",
              "description": "",
              "iconUrl": "https://kanalyzer.atlassian.net/images/icons/statuses/closed.png",
        ...
        },
        {
          "id": "10102",
          "key": "KTD-12",
          "self": "https://kanalyzer.atlassian.net/rest/api/2/issue/10102",
          "fields": {
            "summary": "Add Pretty Print function for the json data on Load Data page.",
            "status": {
              "self": "https://kanalyzer.atlassian.net/rest/api/2/status/10001",
              "description": "",
              "iconUrl": "https://kanalyzer.atlassian.net/images/icons/statuses/closed.png",
      ...
      "customfield_10001": "3_*:*_1_*:*_94932810_*|*_10000_*:*_2_*:*_206022_*|*_10001_*:*_1_*:*_0_*|*_10006_*:*_1_*:*_176021441",
      ...
      "votes": {
        "self": "https://kanalyzer.atlassian.net/rest/api/2/issue/KTD-10/votes",
        "votes": 0,
        "hasVoted": false
      }
    },
      ...
      "histories": [
        {
          ...
          "created": "2015-09-08T10:51:02.832+0200",
          "items": [
            {
              "field": "status",
              "fieldtype": "jira",
        ...
        },
        {
          ...
          "created": "2015-09-08T10:52:06.124+0200",
          "items": [
            {
              "field": "status",
              "fieldtype": "jira",
        ...
        },
        {
          ...
          "created": "2015-09-08T10:52:43.358+0200",
          "items": [
            {
              "field": "assignee",
              "fieldtype": "jira",
        ...
        },
        {
          ...
          "created": "2015-09-09T13:14:18.934+0200",
          "items": [
            {
              "field": "status",
              "fieldtype": "jira",
        ...
        },
        {
          ...
          "created": "2015-09-11T14:08:00.375+0200",
          "items": [
            {
              "field": "resolution",
              "fieldtype": "jira",
